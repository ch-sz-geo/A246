...
==== Klasse `+Forstrevier+`
Die Klasse `+Forstrevier+` führt die Informationen zu den Forstrevieren.
...
==== Klasse `+Gebiet+`
Die Klasse `+Gebiet+` führt die Informationen zu den Gebieten. Die Klasse enthält die Geometrie.
...
==== Klasse `+Person+`
Die Klasse `+Person+` führt die Informationen zu den Forstkreisen.
